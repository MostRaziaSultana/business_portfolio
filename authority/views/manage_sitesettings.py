...
class AddSiteSettingView(LoginRequiredMixin,AdminPassesTestMixin, CreateView):
    ...
    def form_valid(self, form):
        messages.success(self.request, "SEO Setting Added Successfully")
...
class UpdateSiteSettingView(LoginRequiredMixin,AdminPassesTestMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "Update SEO Setting"
        return context

    def form_valid(self, form):
        messages.success(self.request, "SEO Setting Updated Successfully")
        return super().form_valid(form)
...
class SiteSettingDeleteView(LoginRequiredMixin, AdminPassesTestMixin, DeleteView):
    def post(self, request, pk):
        ...
        site_setting.delete()
        messages.success(request, "SEO_setting deleted successfully.")
